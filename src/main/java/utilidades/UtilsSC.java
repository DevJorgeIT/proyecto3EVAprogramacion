...
public class UtilsSC {
    ...
    public static int orderInt() throws MyException {
        ...
        String num = UtilsSC.orderString("Inserta un numero: ");
        int result;
    ...
    public static float orderFloat() throws MyException {
         //DECLARO E INICIALIZO LAS VARIABLES LOCALES
        String f = UtilsSC.orderStringConPunto("Inserta un numero decimal(float): ");
        float result;
        // CONDICIONES Y LANZAMIENTO "MyExcepcion"
        try {
    ...
    public static double orderDouble() throws MyException {
         //DECLARO E INICIALIZO LAS VARIABLES LOCALES
        String d = UtilsSC.orderStringConPunto("Inserta un numero decimal largo(double): ");
        double result;
        // CONDICIONES Y LANZAMIENTO "MyExcepcion"
        try {
     ...
     * @throws MyException --> Excepciones del metodo UtilsSC.orderString() || EXCEPCIONES METODO orderStringBoolean() --> 
    ...
    public static boolean orderStringBoolean() throws MyException {
        // DECLARO E INICIALIZO LAS VARIABLES LOCALES
        String w = UtilsSC.orderString("Inserta true o false(Cadena de texto)");
